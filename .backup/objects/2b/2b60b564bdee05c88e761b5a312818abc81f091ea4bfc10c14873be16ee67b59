...
namespace WarmAsBefore.ViewModels
{
    ...
    public sealed partial class BattleViewModel : ObservableObject
    {
        ...
        /// 公开进入战斗的方法（由外部调用）
        /// </summary>
        public void EnterBattle(List<BattleCharacter> players, List<BattleCharacter> enemies)
        {
